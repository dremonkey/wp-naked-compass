	...
	StarkHTML5 is a modification of the Starkers Theme.
	...
	felt were unnecessary. So in a way making this
	even more barebones that Starkers was. 

	StarkHTML5 is free and fully GPL-licensed, 
	...
	2. Update all plugins so that they add scripts in the footer rather than head
	...
	Changed so that HTML comments are stripped out of *.php files rather than just *.html files. Solution based on:
